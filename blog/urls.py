...
urlpatterns=[
    ...
    path('article/<int:pk>/modifier/', views.modifier_article, name='blog/nouvel_article'), # Route pour modifier un article, le int pk représente l'identifiant unique de l'article
]